...
class GPTAnswerer:
    def __init__(self, openai_api_key):
        self.llm_cheap = LoggerChatModel(
            ChatOpenAI(model_name="llama-3.1-sonar-small-128k-online", base_url="https://api.perplexity.ai", logprobs= None,top_logprobs =None, openai_api_key=openai_api_key, temperature=0.4)
        )
    @property
